-- Add owner_id to charger JSONB in both reservation RPCs
-- so the client can notify the charger owner when a driver cancels.
-- Uses subquery pattern to avoid PG 15+ GROUP BY strictness.

-- 1. get_driver_reservations_rpc — add 'owner_id'
